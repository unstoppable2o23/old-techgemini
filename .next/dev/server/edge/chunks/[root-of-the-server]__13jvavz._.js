...
function middleware(request) {
    ...
    if (PUBLIC_PATHS.some((p)=>pathname.startsWith(p)) || pathname.startsWith("/_next") || pathname.startsWith("/static") || pathname === "/favicon.ico") {
...
function extractSubdomain(hostname) {
    ...
    if (hostname.includes("localhost") || hostname.includes("127.0.0.1") || parts.length < 3) {
        return "default";
    }
    return parts[0];
}
